...
class Guia_Remision extends Model
{
    ...
    public function scopeClientesDistinsc($query){
        return $query->join('cliente','cliente.cliente_id','=','guia_remision.cliente_id')->join('bodega','bodega.bodega_id','=','guia_remision.bodega_id')->join('sucursal','sucursal.sucursal_id','=','bodega.sucursal_id')->join('tipo_identificacion','tipo_identificacion.tipo_identificacion_id','=','cliente.tipo_identificacion_id')->where('sucursal.empresa_id','=',Auth::user()->empresa_id)->where('gr_estado','=','1')->orderBy('cliente.cliente_nombre','asc');
    }
