...
<div class="card card-primary card-outline">
    <form class="form-horizontal" method="POST" action="{{ url("prefactura/factura") }}" onsubmit="return validacion()">
        @csrf
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-xs-7 col-sm-7 col-md-7 col-lg-7">
                    ...
                    @endif
                    <!--
                        <a href="{{ url("listaGuiasprefacturaes") }}" class="btn btn-danger btn-sm not-active-neo"><i
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                            <div class="form-group">
                                <div class="form-line">
                                    ...
                                    <input id="rango_id" name="rango_id" value="{{ $rangoDocumento->rango_id }}"
                                        type="hidden"> 
                                        <input id="prefactura_id" name="prefactura_id" value="{{ $prefactura->prefactura_id }}"
                                        type="hidden"> 
                    ...
                    <div class="row clearfix form-horizontal">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" style="margin-bottom : 0px;">
                            <div class="form-group">
                                <input id="clienteID" name="clienteID" type="hidden" value="{{ $prefactura->cliente_id }}">
                                ...
                                <input id="buscarCliente" name="buscarCliente"  type="hidden"  class="form-control "
                                    placeholder="Cliente" value="{{ $prefactura->cliente->cliente_nombre }}"   required >
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    ...
                                    <input type="hidden" id="idCedula" name="idCedula" class="form-control "
                                        placeholder="Ruc"  value="{{ $prefactura->cliente->cliente_cedula }}"   required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    ...
                                    <input type="hidden" id="idTipoCliente" name="idTipoCliente" class="form-control "
                                        placeholder="Tipo" value="{{ $prefactura->cliente->tipoCliente->tipo_cliente_nombre }}"  required>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="margin-bottom : 0px;">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    ...
                                    <input type="hidden" id="idDireccion" name="idDireccion" class="form-control "
                                        placeholder="Direccion" value="{{ $prefactura->cliente->cliente_direccion }}"  required>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1  form-control-label"
                            ...
                            <div class="form-group">
                                <label class="form-control"  >{{ $prefactura->bodega->bodega_nombre }}</label>
                                    <input type="hidden" id="bodega_id" name="bodega_id" class="form-control "
                                        placeholder="Telefono" value="{{ $prefactura->bodega->bodega_id }}" >
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    ...
                                    <input type="hidden" id="idTelefono" name="idTelefono" class="form-control "
                                        placeholder="Telefono" value="{{ $prefactura->cliente->cliente_telefono }}" >
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1 form-control-label  "
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="margin-bottom : 0px;">
                            <div class="form-group">
                                ...
                                <input type="hidden" id="factura_tipo_pago" name="factura_tipo_pago" class="form-control "
                                        placeholder="Direccion" value="{{ $prefactura->prefactura_tipo_pago }}"  >   
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" style="margin-bottom : 0px;">
                            <div class="form-group">
                                ...
                                <input type="hidden" id="factura_porcentaje_iva" name="factura_porcentaje_iva" class="form-control "
                                        placeholder="Telefono" value="{{ $prefactura->prefactura_porcentaje_iva }}" >
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2"
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    ...
                                    <input type="hidden" id="factura_dias_plazo"
                                        name="factura_dias_plazo" 
                                         value="{{$prefactura->prefactura_dias_plazo}}" onkeyup="calcularFecha()"
                                        required reaf>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <table  > 
                                            @if(isset($guias))
                                                @foreach($guias as $guia) 
                                                    <tr ><td>{{ $guia->gr_numero}} <input class="invisible" name="Dguias[]" value="{{ $guia->gr_id}}"/> </td> </tr>
                                                @endforeach
                                            @endif
                                        </table >
                                                        ...
                                                        <div class="form-line">
                                                            <textarea id="factura_comentario" name="factura_comentario"
                                                                rows=3 class="form-control "
                                                                  placeholder="Escribir aqui.." maxlength="300">Factura generado por la Guia N° @if(isset($guias)) @foreach($guias as $guia) {{ $guia->gr_numero}}, @endforeach @endif
                                                            </textarea>
                                                        </div>
                                                    </div>
                                                </div>
...
function cargarmetodo() {
    ...
    document.getElementById("factura_porcentaje_iva").value='<?php echo($prefactura->prefactura_porcentaje_iva); ?>';
    document.getElementById("bodega_id").value='<?php echo($prefactura->bodega_id); ?>';  
    <?php
