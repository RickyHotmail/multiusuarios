...
<div class="card card-primary card-outline">
    <form class="form-horizontal" method="POST" action="{{ route('ordenesdespachoCM.destroy', [$orden->orden_id]) }}" >
        @method('DELETE')
        @csrf
                ...
                <div class="col-xs-7 col-sm-7 col-md-7 col-lg-7">
                    <div class="float-right">
                        <button type="submit" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i>&nbsp;Eliminar</button>
                         <!--
                        <button type="button" onclick='window.location = "{{ url("listaOrdenes") }}";' class="btn btn-default btn-sm"><i class="fa fa-undo"></i>&nbsp;Atras</button>        
                        -->      
                    ...
                    <div class="row clearfix form-horizontal">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                            <div class="form-group">
                                <div class="form-line">
                                <label class="form-control" id="orden_serie" name="orden_serie"  value="{{$orden->orden_serie}}">{{$orden->orden_serie}}</label>   
                            ...
                            <div class="table-responsive">
                                ...
                                <table id="cargarItemorden"
                                    ...
                                    @foreach($orden->detalles as $x)
                                        ...
                                        <td >@if(isset($x->movimientop)) <?php echo number_format($x->movimientop->movimiento_valor, 2)?> @else 0 @endif</td>    
