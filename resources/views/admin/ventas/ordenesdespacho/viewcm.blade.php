...
@section('principal')
<form class="form-horizontal" method="POST" action="{{ url("ordenDespacho/guiacm") }}">
@csrf
    <div class="card card-secondary">
        ...
        <div class="card-body">
            ...
            <div class="card-body table-responsive p-0" style="height: 700px;">
                <table id="example4" class="table table-bordered table-hover table-responsive " >
                    <thead>
                    ...
                    <tbody>
                            ...
                            @if(isset($ordenes))
                                ...
                                <tr> 
                                    ...
                                    <a href="{{ url("ordenDespachoCM/{$x->orden_id}/visualizar") }}" class="btn btn-xs btn-success" data-toggle="tooltip" data-placement="top" title="Ver"><i class="fa fa-eye"></i></a>   
                                    ...
                                    @if( $x->orden_estado ==1) 
                                        <a href="{{ url("ordenDespachoCM/{$x->orden_id}/eliminar") }}" class="btn btn-xs btn-danger" data-toggle="tooltip" data-placement="top" title="Eliminar"><i class="fa fa-trash" aria-hidden="true"></i></a> 
                                    @endif   
                                    <!-- 
                                    @if( $x->orden_estado ==1)   
