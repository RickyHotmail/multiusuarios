...
<div class="card card-primary card-outline">
    <form class="form-horizontal" method="POST" action="{{ url("prefactura") }}" onsubmit="return validacion()">
        @csrf
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="margin-bottom : 0px;">
                            <div class="form-group">
                                <select id="factura_tipo_pago" name="factura_tipo_pago" class="form-control show-tick "
                                    data-live-search="true" onchange="credito();">
                                    <option value="EN EFECTIVO" @if($guiadatos->orden_tipo_pago =="EN EFECTIVO") selected @endif >EN EFECTIVO </option>
                                    <option value="CONTADO" @if($guiadatos->orden_tipo_pago =="CONTADO") selected @endif >CONTADO</option>
                                    <option value="CREDITO" @if( $guiadatos->orden_tipo_pago =="CREDITO") selected @endif >CREDITO</option>
                                </select>
                    ...
                    <div class="row clearfix form-horizontal">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="margin-bottom : 0px;">
                            <div class="form-group">
                                <select id="factura_tipo" name="factura_tipo" class="form-control show-tick "
                                    data-live-search="true" >
                                    <option value="AGUAJE">AGUAJE</option>
                                    <option value="SEMANA">SEMANA</option>
                                    <option value="MES Y AÑO">MES Y AÑO</option>
                                </select>  
                            </div>
                        </div>
                        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1 form-control-label  "
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" style="margin-bottom : 0px;">
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="factura_aguaje" name="factura_aguaje" class="form-control "
                                        placeholder="Numero"
                                        value='' required />
                                </div>
                            </div>
