<table class="invisible">
    <tbody id="plantillaItemFactura">
        <tr id="row_{ID}">
            <td>{Dfecha}<input class="invisible" name="Dfecha[]" value="{Dfecha}" /></td>
            <td>{Dguia}<input class="invisible" name="Dguia[]" value="{Dguia}" /><input class="invisible" name="Didguia[]" value="{Didguia}" /></td>
            <td>{Dtransportista}<input class="invisible" name="Dtransportista[]" value="{Dtransportista}" /></td>
            <td>{Dplaca}<input class="invisible" name="Dplaca[]" value="{Dplaca}" /></td>
