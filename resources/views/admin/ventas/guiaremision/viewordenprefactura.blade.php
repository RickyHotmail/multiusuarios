...
<div class="card card-secondary">
    ...
    <!-- /.card-header -->
    <div class="card-body">
        <form class="form-horizontal" method="POST" action="{{ url("guiaordenespre/consultar") }}">
        @csrf
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-3">            
                    <button type="submit" id="buscarpre" name="buscarpre" class="btn btn-primary"><i class="fa fa-search"></i></button>
                    <button type="submit" id="generar" name="generar" class="btn btn-secondary"><i class="fa fa-save"></i><span> PreFactura</span></button>               
