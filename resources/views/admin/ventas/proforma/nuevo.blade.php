...
<div class="card card-primary card-outline">
    <form class="form-horizontal" method="POST" action="{{ url("profor") }}">
        @csrf
        <div class="card-header">
            <div class="row">
                <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
                    <h2 class="card-title"><b>Nueva Proforma</b></h2>
                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    ...
                                    <input id="rango_id" name="rango_id" value="{{ $rangoDocumento->rango_id }}"
                                        type="hidden">
                                    <input type="text" id="proforma_serie" name="proforma_serie"
                    ...
                    <div class="row clearfix form-horizontal">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" style="margin-bottom : 0px;">
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="date" id="proforma_fecha" name="proforma_fecha" class="form-control "
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="margin-bottom : 0px;">
                            <div class="form-group">
                                <div class="form-line">
                                    ...
                                    <input type="hidden" id="saldoPendienteID" name="saldoPendienteID" value="0"
                                        >    
                                </div>
                            </div>
                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <input id="idMontoCredito" type="number"
                                                                ...
                                                                disabled>
                                                                <input type="hidden" id="idTieneCredito" name="idTieneCredito" value="0"> 
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 form-control-label  "
...
<script src="{{ asset('admin/js/ajax/autocompleteProductoProforma.js') }}"></script>
@endsection
