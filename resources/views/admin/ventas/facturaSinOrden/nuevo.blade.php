...
<div class="card card-primary card-outline">
    <form class="form-horizontal" method="POST" action="{{ url("facturacionsinOrden") }}" onsubmit="return validacion()">
        @csrf
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <div class="row clearfix form-horizontal">
                        ...
                        <div id="IdCajaI" class="col-lg-3 col-md-3 col-sm-3 col-xs-3 invisible" style="margin-bottom : 0px;">
                            <div class="form-group">
                                <div class="form-line">
...
var id_item = 1;
var lleva_inventario=@if(isset($sucursal))@if($sucursal->empresa->empresa_control_inventario) true @else false @endif @else false @endif;
