...
<div class="card card-secondary card-tabs" style="position: absolute; width: 100%">
    <div class="card-header p-0 pt-1">
        <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link @if(isset($tab)) @if($tab == '2') active @endif @endif" id="custom-tabs-saldo-cliente-tab" data-toggle="pill"
                    href="#custom-tabs-saldo-cliente" role="tab" aria-controls="custom-tabs-saldo-cliente"
                    aria-selected="false">Saldo de Clientes</a>
            </li>
            @endif
        </ul>
    </div>
