...
<div class="card card-primary card-outline">
    <form class="form-horizontal"  method="POST" action="{{ url("directo") }}">
        @csrf
        <div class="card-header">
            <div class="row">
                <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
                    <h2 class="card-title"><b>Nueva Costo Directo</b></h2>
                </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <div class="row" style="background: #dadada;">
                        ...
                        <div class="col-sm-1" style="margin-bottom: 0px;">
                            <div class="form-group">
                                <select class="form-control select2" id="idsiembra" name="idsiembra"
                                    data-live-search="true">
                                    @foreach($siembras as $siembra)
                                    <option value="{{$siembra->siembra_id}}">{{$siembra->siembra_codigo}}
                                    </option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin-bottom: 0px;">
                            <div class="table-responsive">
                                @include ('admin.camaronera.directo.item')
...
<!-- /.card -->
@section('scriptAjax')
<script src="{{ asset('admin/js/ajax/autocompleteProductodirecto.js') }}"></script>
@endsection
...
function agregarItem() {
    ...
    if ( document.getElementById("id_total").value > 0) {
        ...
        var combo = document.getElementById("idsiembra");
        ...
        linea = linea.replace(/{Dsiembra}/g, combo.options[combo.selectedIndex].text);
        
        
        linea = linea.replace(/{Didconsumo}/g, document.getElementById("idconsumo").value);
        linea = linea.replace(/{Didsiembra}/g, document.getElementById("idsiembra").value);
