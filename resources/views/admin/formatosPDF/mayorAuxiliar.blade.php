        ...
        <tbody>
            @if(isset($datos))
                ...
                <tr class="letra10">
                    ...
                    @else
                        <td @if($datos[$i]['tot'] == '2') style="background:  #C0C4C5;" @endif>@if($datos[$i]['deb'] <> '') <center> {{ number_format(floatval($datos[$i]['deb']),2) }} </center> @endif</td>
                        <td @if($datos[$i]['tot'] == '2') style="background:  #C0C4C5;" @endif>@if($datos[$i]['hab'] <> '') <center> {{ number_format(floatval($datos[$i]['hab']),2) }} </center> @endif</td>
                        <td @if($datos[$i]['tot'] == '2') style="background:  #C0C4C5;" @endif>@if($datos[$i]['act'] <> '') <center> {{ number_format(floatval($datos[$i]['act']),2) }} </center> @endif</td>
