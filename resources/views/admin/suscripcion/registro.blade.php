...
<head>
    ...
    <title>NEOPAGUPA | Registro</title>
            ...
            <noscript>
                ...
                <div class="container-fluid">
                    <div class="card card-secondary">
                        ...
                        <div class="card-body">
                            <form autocmplete="off" class="form-horizontal" method="POST" action="{{url('/suscripcion')}}">
                            @csrf
                                <div class="modal-body">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control" id="idCelular" name="idCelular" placeholder="Ej. 0999999999">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            <label for="idContabilidad" class="col-sm-3 col-form-label">LLeva Contabilidad: *</label>
                                            <div class="col-sm-9">
                                                <div class="icheck-success d-inline">
                                                    <input type="checkbox" id="idContabilidad" name="idContabilidad" checked>
                                                    <label for="idContabilidad"></label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label for="idContribuyente" class="col-sm-3 col-form-label">Contrib. Especial No.</label>
                                            <div class="col-sm-5">
                                        ...
                                        <h4 class="mt-5">Datos de Usuario</h4>
                                        <hr>

                                        <div class="form-group row">
                                            <label for="idNombre" class="col-sm-3 col-form-label">Username: *</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="idNombre" name="idNombre" placeholder="Nombre de Usuario" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label for="idNombreSucursal" class="col-sm-3 col-form-label">Nombre Sucursal: *</label>
                                            <div class="col-sm-9">
                                                <input autocomplete="off" type="text" class="form-control" id="idNombreSucursal" name="idNombreSucursal" value="MATRIZ COMERCIAL" placeholder="Ej.: MATRIZ" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="idDireccionSucursal" class="col-sm-3 col-form-label">Dirección Sucursal: *</label>
                                            <div class="col-sm-9">
                                                <input autocomplete="off" type="text" class="form-control" id="idDireccionSucursal" name="idDireccionSucursal" placeholder="Dirección" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group row">
                                                    <label for="idCodigoSucursal" class="col-sm-6 col-form-label">Código Sucursal: *</label>
                                                    <div class="col-sm-4">
                                                        <input style="text-align:right;" autocomplete="off" type="text" class="form-control" id="idCodigoSucursal" name="idCodigoSucursal" value="001" placeholder="001"  required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group row">
                                                    <label for="idCodigoPuntoVenta" class="offset-sm-2 col-sm-6 col-form-label">Punto de Venta: *</label>
                                                    <div class="col-sm-4">
                                                        <input autocomplete="off" type="text" class="form-control" id="idCodigoPuntoVenta" name="idCodigoPuntoVenta" value="001" placeholder="001" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label for="idSecuencia" class="col-sm-3 col-form-label">Próxima factura: *</label>
                                            <div class="col-sm-2">
                                                <input style="text-align:right;" type="text" class="form-control" id="idSecuencia" name="idSecuencia" value="1" placeholder="Ej.: 1" required>
                                            </div>
                                        </div>
