                ...
                <div class="col-sm-10">
                    ...
                    <div  class="row">  
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <a href="{{ url("rolindividualCM/{$datos[1]['rol_id']}/anularCheque") }}" class="btn btn-danger btn-sm"><i class="fa fa-ban"></i>&nbsp;Anulacion</a>
                             <!-- 
                                ...
                                <!-- Tabla de forma de pagos -->
                                    ...
                                    <div class="card-body">
                                        <div class="tab-content">
                                            ...
                                            @endif
                                            @if( $tipopago[1]['tipo'] =='EFECTIVO')  
                                            <div class="tab-pane active" id="timeline"> 
                                                <div class="form-group row">
                                                    <label for="banco_id_cheque" class="col-sm-3 col-form-label">CAJA</label>
                                                    <div class="col-sm-9">
                                                        <label class="form-control">{{ $tipopago[1]['banco'] }}</label>
                                                    </div>
                                                </div>
                                            ...
                                            @endif
                                            @if( $tipopago[1]['tipo'] =='OTROS')  
                                            <div class="tab-pane active" id="timeline"> 
                                                <div class="form-group row">
                                                    <label for="banco_id_cheque" class="col-sm-3 col-form-label">Movimiento</label>
                                                    <div class="col-sm-9">
                                                        <label class="form-control">{{ $tipopago[1]['banco'] }}</label>
                                                    </div>
                                                </div>
