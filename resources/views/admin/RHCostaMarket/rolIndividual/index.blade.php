                                ...
                                <!-- Tabla de forma de pagos -->
                                    <div  class="card card-secondary">
                                        ...
                                        <div class="card-header p-2">
                                            ...
                                            <li class="nav-item " onclick="Selection('Efectivo')" ><a class="nav-link item" href="#efectivo" data-toggle="tab" >Efectivo</a></li>
                                            <li class="nav-item " onclick="Selection('Otros')" ><a class="nav-link item" href="#otro" data-toggle="tab" >Otros</a></li>
                                            </ul>
                                        ...
                                        <div class="card-body">
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane" id="efectivo"> 
                                                    <div class="form-group row">
                                                        <label for="caja_id" class="col-sm-3 col-form-label">CAJA</label>
                                                        <div class="col-sm-9">
                                                        <select id="caja_id" name="caja_id" class="form-control show-tick" data-live-search="true" disabled>
                                                                @if($cajaAbierta)
                                                ...
                                                <div class="tab-pane" id="otro"> 
                                                    <div class="form-group row">
                                                        <label for="idmovimiento" class="col-sm-3 col-form-label">Otros</label>
                                                        <div class="col-sm-9">
                                                            <select class="custom-select" id="idmovimiento"  name="idmovimiento" disabled >
                                                                <option value="--Seleccione una opcion--" label>--Seleccione una opcion--</option>   
                                ...
                                <div class="card card-primary"> 
                                    ...
                                    <table class="table table-totalVenta">
                                        ...
                                        <tr>
                                            ...
                                            <input type="hidden"   name="FechaReservat"  id="FechaReservat" value="0" required readonly>
                                    ...
                                    <table class="table table-totalVenta">
                                        ...
                                        <tr>
                                            ...
                                            <input type="hidden"   name="calreser"  id="calreser" value="0" required readonly>  
                                            <input type="hidden"   name="diasreser"  id="diasreser" value="0" required readonly>             
                                        </tr>
                                        <tr>
        ...
        success: function(data){
            ...
            if (document.getElementById("afiliadot").value=="1") {
                ...
                if (document.getElementById("tercerot").value=="1") {
                  ...
                  if ( document.getElementById("FechaReservat").value <= document.getElementById("fechafinal").value) {     
                    
               
                    if(mese(document.getElementById("FechaReservat").value)==mese(document.getElementById("fechafinal").value)){
                        
                        document.getElementById("calreser").value='1'; 
                        dateDiffer2(document.getElementById("FechaReservat").value,document.getElementById("fechafinal").value);
                    }
                   
                    if(document.getElementById("acureservat").value=="0"){
                        
                       
                        if(document.getElementById("calreser").value=="1"){
                            document.getElementById("TotalFondosV").innerHTML=round((((Number(document.getElementById("Total_In").value)*Number(document.getElementById("VReservat").value))/100)/30)*Number(document.getElementById("diasreser").value),2);
                            document.getElementById("TFondo").value=round((((Number(document.getElementById("Total_In").value)*Number(document.getElementById("VReservat").value))/100)/30)*Number(document.getElementById("diasreser").value),2);
                            
                           
                        }
                        else{
                            document.getElementById("TotalFondosV").innerHTML=round((Number(document.getElementById("Total_In").value)*Number(document.getElementById("VReservat").value))/100,2);
                    ...
                    if(document.getElementById("acureservat").value=="1"){
                        if(document.getElementById("calreser").value=="1"){
                            ...
                            document.getElementById("Fondol").innerHTML=round((((Number(document.getElementById("Total_In").value)*Number(document.getElementById("VReservat").value))/100)/30)*Number(document.getElementById("diasreser").value),2);
                            document.getElementById("Fondo").value=round((((Number(document.getElementById("Total_In").value)*Number(document.getElementById("VReservat").value))/100)/30)*Number(document.getElementById("diasreser").value),2);
                            
                        }
                        else{
                            
                            document.getElementById("Fondol").innerHTML=round((Number(document.getElementById("Total_In").value)*Number(document.getElementById("VReservat").value))/100,2);
...
function mese(dfecha){
    let fecha2 = new Date(dfecha);
...
function dateDiffer2 (fecha1, fecha2) {
      ...
      document.getElementById("diasreser").value=differDay-1;
}
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            for (var i=0; i<data.length; i++) {
                ...
                document.getElementById("FechaReservat").value= data[i].empleado_fecha_inicioFR;
