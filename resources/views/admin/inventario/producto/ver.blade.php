...
<div class="card card-secondary">
    <div class="card-header">
        ...
        <!--   
        <button onclick='window.location = "{{ url("producto") }}";' class="btn btn-default btn-sm float-right"><i class="fa fa-undo"></i>&nbsp;Atras</button>
        --> 
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <div class="row">
                    <label for="" class="col-sm-3 col-form-label">Tamano</label>
                    <div class="col-sm-9">                        
                ...
                <div class="row">
                    <label for="" class="col-sm-3 col-form-label">Producto Camronera</label>
                    <div class="col-sm-9">    
                        @if($producto->producto_camaronero=="1")
                            <label class="form-control">Directo</label>   
                        @endif             
                        @if($producto->producto_camaronero=="2")
                        <label class="form-control">Indirecto</label>         
                        @endif                    
