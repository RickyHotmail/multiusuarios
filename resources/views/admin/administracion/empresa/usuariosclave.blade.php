...
<div class="card card-secondary">
    <div class="card-header">
        <h3 class="card-title">Restablecer Clave, empresa: 'Pruebas'</h3>
            ...
            <tbody>
                ...
                <tr class="text-center">
                    <td class="form-row">
                        ...
                        <form action="{{ url("administracion/usuarios/{$usuario->user_id}/restablecerclaveusuario") }}" method="post">
                            @csrf
                            <button class="btn btn-xs btn-info" data-toggle="tooltip" data-placement="top" title="Restablecer Contraseña"><i class="fa fa-key" aria-hidden="true"></i></button>
                        </form>
                    </td>
