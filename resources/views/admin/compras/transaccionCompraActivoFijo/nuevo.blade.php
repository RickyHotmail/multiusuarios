...
<div class="card card-primary card-outline">
    <form class="form-horizontal" method="POST"  action="{{ url("transaccionCActivoFijo") }} " onsubmit="return validarForm();">
        @csrf
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12  form-control-label">
                                <table class="table table-totalVenta">
                                    ...
                                    <tr>
                                        ...
                                        <td id="totalXML" class="derecha-texto negrita">{{$totalxml}}
