            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <div class="row clearfix form-horizontal">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" style="margin-bottom : 0px;">
                            <div class="form-group">
                            <label class="form-control" >{{$compras->activo->grupoActivo->grupo_nombre}}</label>
                        ...
                        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1" style="margin-bottom : 0px;">
                            <div class="form-group">
                            <label class="form-control" >{{$compras->activo->activo_vida_util}}</label>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" style="margin-bottom : 0px;">
                            <div class="form-group">
                            <label class="form-control" >{{$compras->activo->activo_depreciacion}} </label>
                            </div>
                        </div>
                    </div>
                    <div class="row">
