<table class="invisible">
    <tbody id="plantillaItem">
        <tr id="row_{ID}">
            <td><a onclick="eliminarItem({ID}, '{Diva}', {Dtotal}, {Ddescuento},'{DbienServ}');" class="btn btn-danger waves-effect" style="padding: 2px 8px;">X</a></td>
            <td>{Dcantidad}<input class="invisible" name="Dcantidad[]" value="{Dcantidad}" /><input class="invisible" name="Dide[]" value="{idep}" /></td>
